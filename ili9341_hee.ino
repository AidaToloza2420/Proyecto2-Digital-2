...
void loop() {
  ...
  LCD_Print(text1, 90, 83, 2, 0xffff, 0x421b);
 //String text2 = "Brandon Cruz y Aida Toloza";
 // LCD_Print(text2, 69, 83, 2, 0xffff, 0x421b);
  String text2 = "Brandon Cruz y Aida Toloza";
  LCD_Print(text2, 70, 100, 1, 0x421b, 0xffff);
  String text3 = "Presiona para comenzar";
  LCD_Print(text3, 80, 125, 1, 0x421b, 0xffff);
